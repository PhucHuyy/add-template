                        ...
                        <form className="add-feild">
                            ...
                            <div className="col-md-6 col-sm-6">
                                <div className="input-group">
                                    ...
                                    <input type="date" className="form-control" required placeholder="Date Of Birth" onChange={(e) => { setDateOfBirth(e.target.value) }} />
                                </div>
                            </div>
                            <div className="col-md-6 col-sm-6">
                                <div className="input-group">
                                    <label style={{ textAlign: 'start' }}>University <span style={{ color: 'red' }}>*</span></label>
                                    <input type="text" className="form-control" required placeholder="University" onChange={(e) => { setUniversity(e.target.value) }} />
                                </div>
                            </div>
                            ...
                            <div className="col-md-6 col-sm-6">
                                <div className="input-group">
                                    ...
                                    <input type="text" className="form-control" required placeholder="Major" onChange={(e) => { setMajor(e.target.value) }} />
                                </div>
                            </div>
                            ...
                            <div className="col-md-6 col-sm-6">
                                <div className="input-group">
                                    ...
                                    <input type="date" className="form-control" required placeholder="Start Time" onChange={(e) => { setAcademicYearStart(e.target.value) }} />
                                </div>
                            </div>
                            ...
                            <div className="col-md-6 col-sm-6">
                                <div className="input-group">
                                    ...
                                    <input type="date" className="form-control" placeholder="End Time" onChange={(e) => { setAcademicYearEnd(e.target.value) }} />
                                </div>
                            </div>
                            ...
                            <div className="col-md-12 col-sm-12">
                                <div className="input-group">
                                    ...
                                    <input type="text" className="form-control" required placeholder="Address" onChange={(e) => { setAddress(e.target.value) }} />
                                </div>
                            </div>
                            ...
                            <div className="col-md-12 col-sm-12">
                                <div className="input-group">
                                    ...
                                    <input type="text" className="form-control" required placeholder="Phone number" onChange={(e) => { setPhoneNumber(e.target.value) }} />
                                </div>
                            </div>
                            <div className="col-md-12 col-sm-12">
