...
import { ManageCv as ManageCvservice } from '../../../../services/user/ManageCv/ManageCv';
...
export default function ManageCv() {
    ...
    const handleEdit = async (cvid: string, currentTitle: string, url: string) => {
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <form>
                                                ...
                                                {/* Input Upload File */}
                                                <div style={{ marginBottom: '10px', position: 'relative', display: 'inline-block', textAlign: 'center' }}>
                                                    <input
                                                        type="file"
                                                        id="file-upload"
                                            ...
                                            <div className="mng-company">
                                                <div className="col-md-2 col-sm-2">
                                                    <div className="mng-company-pic">
                                                        <img src="https://png.pngtree.com/png-vector/20190721/ourmid/pngtree-cv-icon-for-your-project-png-image_1555553.jpg" className="img-responsive" alt="" />
                                                    </div>
                                                </div>
                                                <div className="col-md-3 col-sm-3">
                                                    <div className="mng-company-name">
                                                        <h4> <span className="cmp-tagline">{cv.title + ""}</span></h4>
                                                        <span className="cmp-time">{new Date(cv.createdAt).toLocaleDateString()
                                                        }</span>
                                                    </div>
                                                </div>
                                                <div className="col-md-5 col-sm-5">
                                                    <div className="mng-company-name">
                                                        <span className="cmp-tagline">{getFileNameFromUrl(cv.cvDetail)}</span>
                                                    </div>
                                                </div>
                                                <div className="col-md-2 col-sm-2">
                                                    <div className="mng-company-action">
                                                        ...
                                                        }} data-toggle="tooltip" title="Edit"><i className="fa fa-edit"></i></a>
                                                        <a href="#" onClick={(e) => {
                                                            e.preventDefault();
                                                            handleDelete(cv.cvId);
                                                        }} data-toggle="tooltip" title="Delete"><i className="fa fa-trash-o"></i></a>
                                                        <a href={cv.cvDetail} target="_blank" rel="noopener noreferrer" data-toggle="tooltip" title="Delete"><i className="fa fa-eye"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </article>
