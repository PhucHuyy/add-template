...
export class StudentProfileService {
  ...
  async getStudentProfile(): Promise<StudentProfile | null> {
    try {
      const response = await axiosPrivateProfileServcie.get<ApiResponse<StudentProfile>>('/student_profiles/viewprofile');
  ...
  async getRequestStudent(): Promise<RequestStudents> {
    try {
      const response = await axiosPrivateProfileServcie.get<ApiResponse<RequestStudents>>('/requeststudent/getrequest');
